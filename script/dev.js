...
fs.mkdirSync('./dist');
fs.mkdirSync('./dist/aardvarc');
fs.mkdirSync('./dist/aardvarc/style');

// move static files
copyDir('./static', './dist/aardvarc');
...
function renderStyle() {
  ...
  for (const styleFile of styleFiles) {
    ...
    try {
      ...
      fs.writeFileSync(`./dist/aardvarc/style/${styleFile}.css`, result.css);
      fs.writeFileSync(`./dist/aardvarc/style/${styleFile}.css.map`, result.map);
    } catch (e) {
      styleError = true;
...
function renderTemplate() {
  ...
  for (const pugFile of pugFiles) {
    ...
    try {
      ...
      fs.writeFileSync(`./dist/aardvarc/${pugFile}.html`, html);
    } catch (e) {
      pugError = true;
